...
//    char *p1 = BN_bn2hex (order);
//    if (p1)
//    {
//        printf ("n is 0x%s/n", p1);
//        OPENSSL_free (p1);
//    }
...
//    char *cx1 = BN_bn2hex (ctext_struct.C1x);
//    if (cx1)
//    {
//        printf ("cx1 is 0x%s\n", cx1);
//        OPENSSL_free (cx1);
//    }
//    char *cy1 = BN_bn2hex (ctext_struct.C1y);
//    if (cy1)
//    {
//        printf ("cy1 is 0x%s\n", cy1);
//        OPENSSL_free (cy1);
...
//    size_t retval = 0;
//    for (; retval < strlen(ctext_struct.C3->data); retval++)
//        printf("%02X", ctext_struct.C3->data[retval]);
//    printf("\n");
//
//
//    size_t retval1 = 0;
//    for (; retval1 < strlen(ctext_struct.C2->data); retval1++)
//        printf("%02X", ctext_struct.C2->data[retval1]);
//    printf("\n");
//
//
//    char bufferC3[1024];
//    convertUnCharToStr(bufferC3, ctext_struct.C3->data, strlen(ctext_struct.C3->data));
//    printf("buffer==== %s\n", bufferC3);
//
//    char bufferC2[1024];
//    convertUnCharToStr(bufferC2, ctext_struct.C2->data, strlen(ctext_struct.C2->data));
//    printf("buffer==== %s\n", bufferC2);
                ...
                size_t ciphertext_len, uint8_t *ptext_buf, size_t *ptext_len)
{
    ...
    char *p2 = BN_bn2hex (sm2_ctext->C1y);
    if (p2)
    {
        printf ("n is 0x%s/n", p2);
        OPENSSL_free (p2);
    }
